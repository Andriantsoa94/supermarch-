    ...
    <div class="page-center">
        <div class="card card--narrow">
            ...
            <div class="brand-header">
                <div class="brand-icon">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V6h16v12zM6 10h2v2H6zm0 4h2v2H6zm4-4h2v2h-2zm0 4h2v2h-2zm4-4h4v6h-4z" />
                    </svg>
                </div>
            ...
            <a href="<?= base_url('/logout') ?>" class="btn"
                style="display: inline-block; margin-bottom: 20px; text-align: center; text-decoration: none; background-color: #f8d7da; color: #721c24; padding: 8px 15px; border: 1px solid #f5c6cb;">
                Déconnexion
            </a>
